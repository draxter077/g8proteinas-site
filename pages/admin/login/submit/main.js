export default function submit(){
    ...
    submit.addEventListener(
        "click",
        function a(e){
            let user = e.target.parentElement.children[1].children[0].value
            let password = e.target.parentElement.children[1].children[1].value
            ...
            log = {
                ...
                users:[
                    ...
                    {
                        id:1,
                        cnpj:"12.123.123/0001-16",
                        businessName:"12 Peixaria e Sushi",
                        responsibleName:"Manuel de Peixes",
                        email:"manuel@joao.com.br",
                        phoneNumber:"(041) 99171-8360",
                        orders:[
                    {
                        id:1232123,
